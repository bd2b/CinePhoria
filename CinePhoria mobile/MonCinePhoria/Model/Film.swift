...
struct ImageFilm: Hashable, Codable {
    var id: UUID = UUID()
    var image1024Name: String
    var image128Name: String
    
    
    func image128() -> Image {
        Image(image128Name)
    }
    func image1024() -> Image {
        Image(image1024Name)
    }
...
""", filmAuthor: "De Nicolas Benamou", filmDistribution: "Avec José Garcia, André Dussollier, Caroline Vigneaux", imageFilm: ImageFilm(image1024Name: "15-1024" , image128Name: "15-128")),
...
""", filmAuthor: "De Todd Phillips", filmDistribution: "Avec Joaquin Phoenix, Lady Gaga, Brendan Gleeson ", imageFilm: ImageFilm(image1024Name: "2-1024" , image128Name: "2-128")) ,
...
""", filmAuthor: "De François Truffaut", filmDistribution: "Avec Catherine Deneuve, Gérard Depardieu, Jean Poiret", imageFilm: ImageFilm(image1024Name: "14-1024" , image128Name: "14-128"))
