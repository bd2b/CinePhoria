...
INSERT INTO SeatsForTarif
  ...
  numberSeats) 
VALUES 
  (UUIDTarifQualite1, UUIDReservation1, 1),
  (UUIDTarifQualite2, UUIDReservation1, 1),
  (UUIDTarifQualite3, UUIDReservation2, 2),
  (UUIDTarifQualite7, UUIDReservation3, 3),
  (UUIDTarifQualite8, UUIDReservation3, 3)
  ;
