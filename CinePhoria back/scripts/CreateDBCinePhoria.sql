...
CREATE TABLE Seance (
  ...
  hourBeginHHSMM    varchar(100) NOT NULL, 
  hourEndHHSMM      varchar(100) NOT NULL, 
...
CREATE PROCEDURE CreateUtilisateur(
    ...
    OUT p_Result VARCHAR(255) -- utilisateurId ou "Erreur : erreur interne procedure." ou "Erreur : email existant." ou "Erreur : utilisateur existant"
)
BEGIN
	DECLARE v_utilisateur_exist INT;
...
CREATE PROCEDURE confirmUtilisateur(
    IN p_utilisateurId VARCHAR(100),
     OUT p_Result VARCHAR(255) -- "OK" ou "Erreur : erreur interne procedure." ou "Erreur : utilisateurId non valide." ou "Warning : Utilisateur deja confirme."
     )
     BEGIN
...
CREATE PROCEDURE ConfirmReserve(
    ...
    OUT p_Result VARCHAR(255) -- "OK" ou "Erreur : erreur interne procedure." ou "Erreur :reservation Id non valide." ou "Warning : reservation deja confirmee"
)
 BEGIN
