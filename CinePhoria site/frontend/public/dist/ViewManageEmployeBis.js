...
function buildEmployeFromForm() {
    ...
    if (firstPasswordEl && confirmPasswordEl) {
        const firstPassword = ((_e = firstPasswordEl.textContent) === null || _e === void 0 ? void 0 : _e.trim()) || '';
        const confirmPassword = ((_f = confirmPasswordEl.textContent) === null || _f === void 0 ? void 0 : _f.trim()) || '';
...
function isFormValid() {
    ...
    if (fP && cP && fP.innerText.trim() !== cP.innerText.trim()) {
        isValid = false;
    ...
    if (isCreatingMode && fP && cP && (fP.innerText.trim().length === 0 || cP.innerText.trim().length === 0)) {
        isValid = false;
    ...
    if (fP && fP.innerText.trim().length > 0 && !isPasswordValid(fP.innerText.trim())) {
        isValid = false;
...
function isFormModified() {
    ...
    if (isDifferent('matricule', (_a = employeSelectedList.matricule) === null || _a === void 0 ? void 0 : _a.toString(10)))
        return true;
    if (isDifferent('firstPassword', firstPassword))
        return true;
    if (isDifferent('confirmPassword', confirmPassword))
        return true;
