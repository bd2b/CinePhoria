...
export class DataControllerSauveCharge extends DataController {
    // Setter pour filterNameCinema repris dans l'extension pour implémenter la nouvelle sauvegarde.
    ...
    sauverEtatGlobal() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(`Taille du snapshotGlobal = ${strGlobal.length} caractères`);
    ...
    sauverTarifs() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            console.log(`Sauvegarde des tarifs => taille = ${str.length}`);
    ...
    sauverCinemas() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const str = JSON.stringify(arr);
            console.log(`Sauvegarde des Cinemas => taille = ${str.length}`);
    ...
    sauverSeancesParCinema() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            mapCinemaToSeances.forEach((seances, cName) => {
                ...
                console.log(`Sauvegarde seances pour '${cName}' => taille ${str.length} chars`);
    ...
    chargerEtatGlobal() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!saved) {
                console.warn("Aucune donnée globale trouvée");
                return;
            }
            try {
                ...
                console.error('Erreur parsing état global', e);
            }
        });
    }
    chargerTarifs() {
    ...
    chargerCinemas() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.error('Erreur parsing cinemas', e);
            }
        });
    }
    chargerSeancesPourCinema(cinemaName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.error('Erreur parsing seances pour', cinemaName, e);
            }
            return [];
        });
    }
    chargerSeancesTousCinemas() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this._Cinemas || this._Cinemas.length === 0) {
                console.warn("Aucun cinéma n’est chargé, impossible de charger les séances tous cinémas.");
                return;
            }
            ...
            console.log(`Toutes les séances de ${this._Cinemas.length} cinémas chargées. Nombre total de séances : ${this._allSeances.length}.`);
        });
    }
    chargerComplet() {
        return __awaiter(this, void 0, void 0, function* () {
