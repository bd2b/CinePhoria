...
if (window.location.hostname === '127.0.0.1' && window.location.port === "3500") document.title = document.title + " - dev";
if (window.location.hostname === '127.0.0.1' && window.location.port === "3600") document.title = document.title + " - stag";
